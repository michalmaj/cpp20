...
int main()
{
	// Playing with basic use of std::weak_ptr
	...
	auto friend_a = person_a->get_friend();
	std::cout << "Friend of Alison: " << friend_a->get_name() << std::endl;

	auto friend_b = person_b->get_friend();
	std::cout << "Friend of Beth: " << friend_b->get_name() << std::endl;
