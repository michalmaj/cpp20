/*
 * We can compound operator with equal sign.
 */
...
int main()
{
	...
	unsigned char sandbox_var{ 0b00110100 }; // 8 bits unsigned
	...
	// Compound left shift
	std::cout << std::endl;
	std::cout << "Shift left 2 bit position in place:" << std::endl;
	sandbox_var <<= 2;
	std::cout << std::setw(COLUMN_WIDTH) << "sandbox_var: "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(sandbox_var) << std::endl;
	std::cout << std::endl;
	...
	std::cout << std::endl;
	std::cout << "Shift right 4 bit position in place:" << std::endl;
	sandbox_var >>= 4;
	std::cout << std::setw(COLUMN_WIDTH) << "sandbox_var: "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(sandbox_var) << std::endl;
	std::cout << std::endl;
	...
	// Compound AND with 0000 1100 to turn off 2 lowest bits
	std::cout << std::endl;
	...
	// We can't compound with NOT, because it is a unary operator
	// But we can still saves change by using assignment operator:
	sandbox_var = ~sandbox_var;
	std::cout << std::setw(COLUMN_WIDTH) << "sandbox_var: "
		<< std::setw(COLUMN_WIDTH) << std::bitset<8>(sandbox_var) << std::endl;
	std::cout << std::endl;
