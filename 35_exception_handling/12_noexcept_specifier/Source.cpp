...
void some_function() noexcept
{
	...
	{
		std::cout << "Handling int exception in free standing function some_function" << std::endl;
		throw; // Rethrowing in noexcept function.method will terminate program 
	}
}
...
int main()
{
	...
	// any means, of you do so the program will terminate, we can
	// also see that the compiler gives us a warning about that.
	//try
	//{
	//	some_function();
	//}
