...
int main()
{
	...
	//auto y = some_var_ref; // y is not deduced as a referenced to double
	//					   // it;s just a double that contains the value
	//					   // is some_var_ref

	//++y; // Only y variable will be incremented
	...
	//++z; // In this case we will modify z, some_var and some_var_ref
