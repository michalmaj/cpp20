/*
 * References:
 *		- Don't use dereferencing fore reading and writing.
 *		- Can't be changed to reference something else.
 *		- Must be initialized at declaration.
 *
 * Pointers:
 *		- Must go through dereference operator to read/write through pointed value.
 *		- Can be changed to point somewhere else.
 *		- Can be declared uninitialized (will contain garbage data). 
 */
