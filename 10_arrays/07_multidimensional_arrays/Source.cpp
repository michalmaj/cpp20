 ...
 * in tabular form. Data in multidimensional arrays are stored in row-major order.
 */
...
int main()
{
	...
	// Use std::size() instead of hard-code number of rows and columns
	...
	// 3D array are defined in the same way. We just use three sets of indexes
	...
	std::cout << std::endl;
	std::cout << "Omitting leftmost dimension for 2D array:" << std::endl;
