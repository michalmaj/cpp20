...
public:
	...
	{
		return ((value >= min_inclusive) and (value <= max_inclusive));
	}
...
int main()
{
	...
	std::cout << "range_sum: " << range_sum(doubles, IsInRange<double>(10.0, 15.5)) << std::endl;
	std::cout << "range_sum: " << range_sum(doubles, IsInRange<double>(10.0, 21.5)) << std::endl;
	std::cout << "range_sum: " << range_sum(doubles, IsInRange<double>(10.0, 41.5)) << std::endl;
	...
	std::cout << "range_sum: " << range_sum(ints, IsInRange<int>(10, 20)) << std::endl; // 10
	std::cout << "range_sum: " << range_sum(ints, IsInRange<int>(10, 30)) << std::endl; // 33
