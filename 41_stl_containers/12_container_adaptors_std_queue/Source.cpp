...
int main()
{
	// Code1: Creating std::queue pushing and accessing
	std::cout << std::endl;
	std::cout << "---------------------------------------" << std::endl;
	std::cout << "Creating std::queue pushing and accessing:" << std::endl;
	...
	// Code2: Modifying through front and back: both return a reference
	std::cout << std::endl;
	std::cout << "---------------------------------------" << std::endl;
	std::cout << "Modifying through front and back:" << std::endl;
	...
	std::cout << std::endl;
	std::cout << "---------------------------------------" << std::endl;
	std::cout << "Specify underlying container:" << std::endl;
