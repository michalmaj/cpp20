...
int main()
{
	...
	// regardless of the order you put them in the collection
	std::cout << std::endl;
	std::cout << "-----------------------------------" << std::endl;
	...
	// A std::map can be though of as a collection of std::pairs
	std::cout << std::endl;
	std::cout << "-----------------------------------" << std::endl;
	...
	// Code3: Keys can be anything
	std::cout << std::endl;
	std::cout << "-----------------------------------" << std::endl;
	std::cout << "Keys can be anything:" << std::endl;
	...
	{
		// Will require usw to add a default constructor to Book.
		// This is an implementation detail of std::map. If we cut out the line
		// using operator[] the requirements for the default constructor goes away
	...
	std::cout << "map is empty: " << std::boolalpha << numbers.empty() << std::endl;
	...
	{
		std::cout << " Couldn't insert in the set. It's a duplicate!" << std::endl;
	}
	print_map(numbers);
