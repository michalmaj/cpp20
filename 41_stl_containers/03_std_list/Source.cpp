...
int main()
{
	...
	// Code2: Iterators forward, back, and constant
	std::cout << "----------------------------------------" << std::endl;
	std::cout << std::endl;
	...
	std::cout << "list is empty: " << std::boolalpha << numbers.empty() << std::endl;
	...
	if (it_insert != numbers.end())
		numbers.insert(it_insert, 333); // Insert before it_insert
	...
	if (it_insert != numbers.end())
		numbers.emplace(it_insert, 444); // Insert before it_insert
