...
int main()
{
	...
	// Replacing
	// basic_string& replace(size_t pos, wize_type count, const basic_string& str);
	...
	//						 size_type pos2, size_type count2 = nops);
	...
	char txt4[15]{}; // Initialize with zero equivalent for characters which is '\0'
	...
	// safe print because the char array was initialized with '\0'
	std::cout << "txt4: " << txt4 << std::endl;
	...
	str5.resize(8); // This fills new char placeholders with null character by default
							// But we can't print and see them.
	std::cout << "str5: " << str5 << std::endl;
	std::cout << "str5.size(): " << str5.size() << std::endl;
	std::cout << "str5.capacity(): " << str5.capacity() << std::endl;
