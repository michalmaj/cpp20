...
int main()
{
	...
	std::string planet{ "Earth. Where the sky is blue" }; // Initialize with literal
	...
	std::string message{ "Hello there", 5 }; // Initialize with part of a string literal
													   // contains hello
	std::string weird_message(4, 'e'); // Initialize with multiple copies of a char 'e'
												 // contains eeee
	std::string greeting{ "Hello World" };
	std::string saying_hello{ greeting, 6, 5 }; // Initialize with part of an existing
														   // string starting at index 6, taking 5
