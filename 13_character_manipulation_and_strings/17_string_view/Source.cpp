...
int main()
{
	...
	// Prints: animal have left
	std::cout << "View with removed suffix(10): " << sv10 << std::endl;

	// Changing the view doesn't change the viewed string:
	std::cout << "Orginal sv10 viewed string: " << c_string1 << std::endl;

	std::cout << "\n======================================\n\n";

	// std::string_view shouldn't outlive whatever it is viewing
