...
#include <iostream>
#include <ios> // for std::hex std::oct
#include <bitset> // for represents bit
...
int main()
{
    ...
    std::bitset<8> bit_var{ "0011" };
    std::cout << "bit var: " << bit_var << std::endl;
    std::cout << "bit var in dec representation: " << bit_var.to_ulong() << std::endl;
